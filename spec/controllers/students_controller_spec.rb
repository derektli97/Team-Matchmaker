...
RSpec.describe StudentsController, type: :controller do
  ...
  let(:valid_attributes) {
    { "first_name" => "Ethan", "last_name" => "Partin", "email" => "123@tamu.edu", "gender" => "M", "ethnicity" => "Hispanic or Latino", "topics" => "Software Engineering",
        "hardware" => true, "electives" => "CSCE 411", "preferences" => "(2:5),(4:6)", "section_id" => 1, "project_id" => nil }
  }
  ...
  describe "POST #create" do
    ...
    #     post :create, params: {student: valid_attributes, :section_id => 1}, session: valid_session
    #     expect(response).to redirect_to(section_students_url)
    #   end
    end
